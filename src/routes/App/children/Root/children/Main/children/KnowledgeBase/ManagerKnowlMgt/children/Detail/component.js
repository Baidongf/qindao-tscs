...
class Detail extends React.Component {
  ...
  componentWillMount() {
    if(this.props.history.action === "POP"){
      this.props.getKnowlDetail(this.id)
    }
  }
      ...
      <div className='knowledge-detail'>
        ...
        <div className='content'>
          ...
          <div className='description'>
            ...
            <div dangerouslySetInnerHTML={{__html: knowlObj.content}} className='description-content'></div>
          </div>
          <div className='description'>
            <div className='title'>附件列表</div>
            <div className='description-content'>
              {
                knowlObj.attachments?(<div>
                  {
                    knowlObj.attachments.map((item,index)=>{
                      return(
